...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Mav', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '哀吾生之须臾，羡长江之无穷', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://aoqoa.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'mav, 博客', // 网站关键词 英文逗号隔开
